  ...
  async function teacherBoard(classId) {
    ...
    try {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        byUid[e.uid] = { streak: e.streak | 0, studyDays: e.studyDays | 0, days: (e.days && typeof e.days === 'object') ? e.days : {}, weekWords: (typeof e.weekWords === 'number' ? e.weekWords : null), flag: (e.flag && typeof e.flag === 'object') ? { fast: e.flag.fast | 0, burst: e.flag.burst | 0, at: e.flag.at || null } : null };
      }
