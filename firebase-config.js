...
window.APPCHECK_SITE_KEY = "6LezMFwtAAAAAM5Ws_cqfk7ds3iTWd5MhAsVCLRr";  // reCAPTCHA v3 사이트키(공개값·커밋안전) → App Check SDK 초기화. ★비밀키는 여기 넣지 말 것(Firebase App Check 콘솔에만). 워커 enforce 는 모니터링 후 별도. (2026-07-20 재발급 — 구키 6Lcl71kt… 는 어테스트가 전 브라우저에서 recaptcha-error 로 실패해 교체)
